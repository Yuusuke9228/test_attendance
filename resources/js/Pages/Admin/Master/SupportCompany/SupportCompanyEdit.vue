...
const props = defineProps({
    supportCompanyDetail: Object,
})

const toast = useToast();
const form = useForm({
    id: props.supportCompanyDetail.id,
    companyName: props.supportCompanyDetail.support_company_name,
    companyPerson: props.supportCompanyDetail?.support_company_person,
    companyEmail: props.supportCompanyDetail?.support_company_email,
    companyTel: props.supportCompanyDetail?.support_company_tel,
    companyZipCode: props.supportCompanyDetail?.support_company_zipcode,
    companyAddress: props.supportCompanyDetail?.support_company_address,
    redirectOption: null
})
...
const submit = (e) => {
    ...
    form.put(route('admin.master.support_company.update'), {
        onSuccess: () => {
...
<template>
    ...
    <AdminLayout title="応援に来てもらう会社">
        <MainContent>
            ...
            <MasterEditBox @emitSubmit=submit link="support_company" :data="supportCompanyDetail">
