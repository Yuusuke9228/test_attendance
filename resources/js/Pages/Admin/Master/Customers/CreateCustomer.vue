...
const submit = (redirectOption) => {
    ...
    form.post(route('admin.master.customer.store'), {
        onFinsh: () => {
            form.reset();
        },
        onSuccess: () => {
...
<template>
    ...
    <AdminLayout title="得意先">
        <MainContent>
            ...
            <MasterCreateForm @emitSubmit=submit link="customer">
                <div class="w-full max-w-7xl input-form">
                    ...
                    <div class="my-4 form-inner center">
                        ...
                        <div class="input-field">
                            <div class="w-full p-input-icon-left">
                                <i class="pi pi-map"></i>
                                <InputText v-model="form.address_1" class="w-full" placeholder="住所１を入力してください。(郵便番号入力時に自動入力されます。)" />
                            </div>
                        </div>
                    </div>
